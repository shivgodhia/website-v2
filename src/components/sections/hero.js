...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Shiv Godhia.</h2>;
  ...
  const four = (
    <>
      <p>
        ...
        and interned{' '}
        <a
          href="https://www.amazon.jobs/en/business_categories/alexa"
          target="_blank"
          rel="noreferrer">
          @Amazon
        </a>
  ...
  const five = (
    <a className="email-link" href="mailto:shivgodhia@gmail.com">
      Get In Touch
    </a>
  );
